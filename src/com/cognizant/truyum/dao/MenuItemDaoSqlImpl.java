...
public class MenuItemDaoSqlImpl implements MenuItemDao{
    ...
    */
    ...
    public List<MenuItem> getMenuItemListAdmin() {
                    ...
                    if(conn!=null){
                                    preparedStatement=conn.prepareStatement("select me_id,me_name,me_active,me_date_of_launch,me_price,me_category,me_free_delivery from menu_item");
                    ...
                    MenuItem menuItem=new MenuItem(id,name,price,activeFlag,dateOfLaunch,category,freeDeliveryFlag);
                    /*emp1.setEmployee_id(empid);
                    emp1.setName(name);
                    emp1.setDate_of_birth(date);
                    emp1.setSalary(sal);*/
    ...
    */
    ...
    public List<MenuItem> getMenuItemListCustomer() {
        ...
        if(connection != null) {
              try {
                    preparedStatement = connection.prepareStatement("select * from menu_item where me_active='Yes' and me_date_of_launch <= now()");
                    resultSet = preparedStatement.executeQuery();
                    boolean activeFlag, freeDeliveryFlag;
                    Date date_of_launch;
                    while(resultSet.next())
                    {
                          ...
                          if(freeDelivery != null && freeDelivery.equals("Yes"))
                                ...
                                freeDeliveryFlag = false;
                          MenuItem menuItem = new MenuItem(menuItemId, name, price, activeFlag, date_of_launch, category, freeDeliveryFlag);
                          menuItemList.add(menuItem);
                    }
    ...
    public void modifyMenuItem(MenuItem menuItem) {
    	...
    	try
    	{
    		if(connection !=null)
    		{
    			...
    			preparestatement.setDate(4,new java.sql.Date(menuItem.getDateOfLaunch().getTime()));
